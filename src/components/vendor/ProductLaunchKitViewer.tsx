...
async function fetchImageFile(imageUrl: string): Promise<File | null> {
  try {
    ...
    return new File([blob], `producto-${Date.now()}.${ext}`, {
      type: blob.type,
    });
  } catch {
    return null;
...
export default function ProductLaunchKitViewer({
  ...
  const shareToInstagram = async () => {
    ...
    const shared = await shareNative(shareText, "ig-share", "Instagram Post");
  ...
  const shareToFacebook = async () => {
    ...
    const shared = await shareNative(shareText, "fb-share", "Facebook Post");
  ...
  const shareToWhatsApp = async () => {
    ...
    const shared = await shareNative(shareText, "wa-share", "WhatsApp");
  ...
  const shareToWhatsAppStatus = async () => {
    const shareText = (kit.whatsapp_message || "") + `\n\n🛒 ${productUrl}`;
    const shared = await shareNative(shareText, "wa-status", "WhatsApp Estado");
  ...
  const shareToTikTok = async () => {
    ...
    const shared = await shareNative(shareText, "tt-share", "TikTok");
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-6 min-h-0">
            ...
            {activeTab === "publish" && (
              <div className="space-y-4">
                ...
                <div className="rounded-xl overflow-hidden bg-gray-100 border-2 border-gray-200 max-w-50 mx-auto shadow-md">
                  <img
                ...
                <button
                  ...
                  className="w-full rounded-2xl bg-linear-to-r from-orange-500 via-pink-500 to-purple-600 py-4 text-base font-black text-white shadow-xl hover:shadow-2xl transition hover:scale-[1.02] active:scale-95 disabled:opacity-50 disabled:cursor-wait"
                >
                  {sharing === "share-all" ? (
                    <>⏳ Preparando...</>
                ...
                <p className="text-center text-[11px] text-gray-500 -mt-1">
                  {isMobile
                    ? "📱 Se abrirá el menú nativo de tu celular con la foto"
                    : "💻 Se abrirá el menú de Windows/Mac con imagen adjunta"}
                </p>
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-3">
                  <button
                    ...
                    disabled={sharing === "ig-share"}
                    className="rounded-xl bg-linear-to-br from-purple-500 via-pink-500 to-orange-400 p-3 sm:p-4 text-white shadow-lg hover:shadow-xl transition hover:scale-105 disabled:opacity-50 disabled:cursor-wait"
                  >
                    <div className="flex items-center gap-2">
                      <div className="text-2xl sm:text-3xl">📷</div>
                      <div className="flex-1 text-left min-w-0">
                        <div className="text-sm sm:text-base font-black truncate">
                          {sharing === "ig-share" ? "⏳..." : "Instagram"}
                        </div>
                        <div className="text-[10px] opacity-90 truncate">
                          {copiedField === "ig-share" ? "✅ Copiado" : "+ 20 hashtags"}
                        </div>
                      </div>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    disabled={sharing === "fb-share"}
                    className="rounded-xl bg-linear-to-br from-blue-600 to-blue-800 p-3 sm:p-4 text-white shadow-lg hover:shadow-xl transition hover:scale-105 disabled:opacity-50 disabled:cursor-wait"
                  >
                    <div className="flex items-center gap-2">
                      <div className="text-2xl sm:text-3xl">📘</div>
                      <div className="flex-1 text-left min-w-0">
                        <div className="text-sm sm:text-base font-black truncate">
                          {sharing === "fb-share" ? "⏳..." : "Facebook"}
                        </div>
                        <div className="text-[10px] opacity-90 truncate">
                          Sin hashtags + link
                        </div>
                  ...
                  <button
                    ...
                    disabled={sharing === "wa-share"}
                    className="rounded-xl bg-linear-to-br from-emerald-500 to-green-600 p-3 sm:p-4 text-white shadow-lg hover:shadow-xl transition hover:scale-105 disabled:opacity-50 disabled:cursor-wait"
                  >
                    <div className="flex items-center gap-2">
                      <div className="text-2xl sm:text-3xl">💬</div>
                      <div className="flex-1 text-left min-w-0">
                        <div className="text-sm sm:text-base font-black truncate">
                          {sharing === "wa-share" ? "⏳..." : "WhatsApp"}
                        </div>
                  ...
                  <button
                    ...
                    disabled={sharing === "wa-status"}
                    className="rounded-xl bg-linear-to-br from-teal-500 to-emerald-600 p-3 sm:p-4 text-white shadow-lg hover:shadow-xl transition hover:scale-105 disabled:opacity-50 disabled:cursor-wait"
                  >
                    <div className="flex items-center gap-2">
                      <div className="text-2xl sm:text-3xl">📱</div>
                      <div className="flex-1 text-left min-w-0">
                        <div className="text-sm sm:text-base font-black truncate">
                          {sharing === "wa-status" ? "⏳..." : "Estado WA"}
                        </div>
                        <div className="text-[10px] opacity-90 truncate">
                  ...
                  <button
                    ...
                    className="col-span-2 rounded-xl bg-linear-to-br from-gray-900 to-black p-3 sm:p-4 text-white shadow-lg hover:shadow-xl transition hover:scale-105 disabled:opacity-50 disabled:cursor-wait"
                  >
                    <div className="flex items-center gap-2 justify-center">
                      <div className="text-2xl sm:text-3xl">🎵</div>
                      <div className="text-left">
                        <div className="text-sm sm:text-base font-black">
                          {sharing === "tt-share" ? "⏳ Preparando..." : "TikTok"}
                        </div>
                        <div className="text-[10px] opacity-90">
                          {copiedField === "tt-share"
                            ? "✅ Copiado"
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border-2 border-pink-200 bg-linear-to-br from-pink-50 to-purple-50 p-4">
                  <div className="mb-2 flex items-center gap-2">
                    ...
                    <span className="ml-auto text-[10px] font-bold text-pink-600">
                      + 20 hashtags
                    </span>
                  </div>
                  <p className="whitespace-pre-wrap text-sm text-gray-800">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={shareToInstagram}
                    disabled={sharing === "ig-share"}
                    className="flex-1 rounded-xl bg-linear-to-r from-purple-500 to-pink-500 py-3 text-sm font-bold text-white shadow disabled:opacity-50"
                  >
                    {sharing === "ig-share" ? "⏳" : "🚀 Compartir"}
                  </button>
                </div>
              </div>
            )}
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={shareToFacebook}
                    disabled={sharing === "fb-share"}
                    className="flex-1 rounded-xl bg-blue-600 py-3 text-sm font-bold text-white shadow disabled:opacity-50"
                  >
                    {sharing === "fb-share" ? "⏳" : "🚀 Compartir"}
                  </button>
                </div>
              </div>
            )}
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <button
                    onClick={shareToWhatsApp}
                    disabled={sharing === "wa-share"}
                    className="rounded-xl bg-emerald-500 py-3 text-xs font-bold text-white shadow disabled:opacity-50"
                  >
                    {sharing === "wa-share" ? "⏳" : "💬 Enviar"}
                  </button>
                  <button
                    onClick={shareToWhatsAppStatus}
                    disabled={sharing === "wa-status"}
                    className="rounded-xl bg-teal-500 py-3 text-xs font-bold text-white shadow disabled:opacity-50"
                  >
                    {sharing === "wa-status" ? "⏳" : "📱 Estado"}
                  </button>
                </div>
              </div>
            )}
            ...
            {activeTab === "email" && kit.email_body && (
              <div className="space-y-4">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() =>
                      handleCopy(buildTextForNetwork("email"), "email-body")
                    }
                    className={`flex-1 rounded-xl py-3 text-sm font-bold ${
