      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Historial de tus compras y seguimiento.
          </p>
        </div>
              ...
              >
                <div className="flex flex-col gap-3 border-b border-gray-100 bg-gray-50 p-5 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-center gap-4">
                    <div
                      className={`flex h-12 w-12 items-center justify-center rounded-2xl text-xl ${status.bg}`}
                    >
                      {status.icon}
                    </div>
                    ...
                    <div>
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span
                          className={`rounded-full px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider ${status.bg} ${status.text}`}
                        >
                ...
                <div className="p-5">
                  ...
                  {/* 🆕 Botón Ver seguimiento en vivo (FASE 4B) */}
        ...
        >
          ...
          >
            ...
            <div className="space-y-4 p-6">
              {/* 🆕 Botón grande de tracking en el modal (FASE 4B) */}
              ...
              <div className="rounded-2xl bg-gray-50 p-4">
                ...
                <div className="mt-2 font-bold text-gray-900">
                  {selectedOrder.store?.name ?? "Tienda"}
                </div>
