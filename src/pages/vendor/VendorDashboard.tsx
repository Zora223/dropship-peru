...
// 🎨 v22.29 - Escalera de Éxito: Inicio = 15 Kits (recalculada)
...
/** Escalera recalculada: Inicio = 15 Kits */
function getTierInfo(monthlySales: number) {
  if (monthlySales >= 150) {
    return {
      ...
      kitsLabel: "♾️ ILIMITADOS",
      autoFillLabel: "♾️ ILIMITADAS",
  ...
  if (monthlySales >= 60) {
    return {
      ...
      kitsLabel: "150 Kits / mes",
      autoFillLabel: "♾️ ILIMITADAS",
      nextRewardMsg: `Te faltan ${150 - monthlySales} ventas para DIAMANTE (IA total ilimitada + VIP)`,
    };
  }
  ...
  if (monthlySales >= 50) {
    return {
      ...
      perks: [
        ...
        "Cargas Auto-Fill IA ILIMITADAS",
        "Plantillas de Marketing VIP",
      ],
      kitsLabel: "80 Kits / mes",
      autoFillLabel: "♾️ ILIMITADAS",
      nextRewardMsg: `Te faltan ${60 - monthlySales} ventas para PLATINO (150 Kits)`,
    };
  }
  ...
  if (monthlySales >= 40) {
    return {
      ...
      kitsLabel: "50 Kits / mes",
      autoFillLabel: "100 Cargas / mes",
      nextRewardMsg: `Te faltan ${50 - monthlySales} ventas para ORO (80 Kits + Auto-Fill ilimitado)`,
    };
  }
  ...
  if (monthlySales >= 30) {
    return {
      ...
      kitsLabel: "30 Kits / mes",
      autoFillLabel: "60 Cargas / mes",
      nextRewardMsg: `Te faltan ${40 - monthlySales} ventas para PLATA (50 Kits + 100 Auto-Fills)`,
    };
  }

  // INICIO / PRUEBA — base 15 kits
  return {
    ...
    perks: [
      "15 Kits de Publicidad IA este mes",
      "30 Cargas Auto-Fill IA este mes",
      "Reuso ILIMITADO de tus Kits guardados",
    ],
    kitsLabel: "15 Kits / mes",
    autoFillLabel: "30 Cargas / mes",
    nextRewardMsg: `Te faltan ${30 - monthlySales} ventas para Membresía S/ 0.00 + 30 Kits IA`,
  };
}
  ...
  if (!store) {
    return (
      <div className="rounded-3xl bg-white p-16 text-center shadow-sm">
        ...
        <h2 className="mt-4 text-xl font-bold text-gray-900">Aún no tienes tienda</h2>
  ...
  return (
    <div className="space-y-6 py-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Mi Tienda 👋</h1>
          <p className="mt-1 text-gray-500">
            Resumen de <span className="font-semibold text-gray-700">{store.name}</span>
          </p>
        </div>
        <button
      ...
      {/* Escalera de Éxito */}
      <div
        className={`overflow-hidden rounded-3xl border-2 border-emerald-400/40 bg-linear-to-br ${tier.color} p-6 text-white shadow-xl relative`}
      >
        ...
        <div className="relative z-10 space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
              ...
              <h2 className="text-xl sm:text-2xl font-black mt-2">{tier.name}</h2>
            </div>
          ...
          <p className="text-xs sm:text-sm text-gray-200 leading-relaxed max-w-2xl">
            <strong>Mientras más vendes, más herramientas desbloqueas.</strong> Empiezas con{" "}
            <strong>15 Kits IA</strong>. A partir de 30 ventas al mes tu membresía queda en S/ 0.00
            y subes a 30 Kits. Reutilizar kits guardados siempre es gratis.
          </p>
          ...
          <div className="space-y-1.5 pt-2">
            ...
            <p className="text-xs font-semibold text-amber-200 mt-1">🔥 {tier.nextRewardMsg}</p>
          </div>
          ...
          <div className="pt-4 border-t border-white/10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 text-xs">
              {tier.perks.map((perk, idx) => (
                <div
                  key={idx}
                  className="flex items-center gap-2 bg-white/10 rounded-xl px-3 py-2 backdrop-blur"
                >
          ...
          <div className="pt-3 border-t border-white/10 grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
            <div className="bg-white/10 rounded-2xl p-3 backdrop-blur border border-white/10">
              ...
              <span className="text-base font-extrabold text-white">{tier.kitsLabel}</span>
            ...
            <div className="bg-white/10 rounded-2xl p-3 backdrop-blur border border-white/10">
              ...
              <span className="text-base font-extrabold text-white">{tier.autoFillLabel}</span>
              <span className="text-[10px] text-emerald-300 block mt-0.5">
                Publica productos en 1 click
              </span>
            </div>
            ...
            <div className="bg-white/10 rounded-2xl p-3 backdrop-blur border border-white/10">
              ...
              <span className="text-base font-extrabold text-amber-300">100% GRATIS</span>
              <span className="text-[10px] text-gray-300 block mt-0.5">
                Reutiliza captions sin gastar cuota
              </span>
            </div>
          </div>
      ...
      {productCreated && (
        <div className="rounded-2xl border-l-4 border-emerald-500 bg-emerald-50 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-bold text-emerald-900">¡Producto guardado!</div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard
          ...
          icon="💰"
          color="success"
          trend={{ value: stats.this_month.growth_pct, label: "vs mes pasado" }}
        ...
        <StatCard
          ...
          icon="📈"
          color="info"
          trend={{ value: stats.this_week.growth_pct, label: "vs semana pasada" }}
            ...
            <div className="rounded-2xl border-l-4 border-orange-500 bg-orange-50 p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="font-bold text-orange-900">Productos con stock bajo</div>
                  <p className="mt-1 text-sm text-orange-800">
                    {stats.totals.low_stock} producto
                    {stats.totals.low_stock === 1 ? "" : "s"} con 5 unidades o menos.
                  </p>
                  <Link
                    to="/vendor/products"
          ...
          {stats.totals.out_of_stock > 0 && (
            <div className="rounded-2xl border-l-4 border-red-500 bg-red-50 p-4">
              <div className="flex items-start gap-3">
                <span className="text-2xl">❌</span>
                <div className="flex-1">
                  <div className="font-bold text-red-900">Productos agotados</div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="space-y-6 lg:col-span-2">
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            <div className="flex items-start justify-between gap-4">
              <div>
                <h2 className="text-lg font-bold text-gray-900">📊 Ventas últimos 7 días</h2>
                <p className="mt-1 text-sm text-gray-500">
                  Total:{" "}
                  <span className="font-bold text-gray-900">{formatCurrency(totalWeekChart)}</span>
                </p>
              </div>
              <span
            ...
            <div className="mt-6">
              <MiniChart
                data={salesChart.map((d) => ({ label: d.label, value: d.total }))}
                color="#e11d48"
                height={160}
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">Pedidos más recientes de tu tienda.</p>
              </div>
              <Link
                to="/vendor/orders"
            ...
            {recentOrders.length === 0 ? (
              <div className="mt-6 rounded-2xl bg-gray-50 p-8 text-center">
                ...
                <h3 className="mt-3 font-bold text-gray-900">Aún no tienes pedidos</h3>
              </div>
            ) : (
              <>
                      ...
                      {recentOrders.map((order) => (
                        <tr key={order.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-4 py-3">
                            ...
                            >
                              {STATUS_CONFIG[order.status].emoji} {STATUS_LABELS[order.status]}
                            </span>
                          </td>
                        </tr>
                      ))}
        ...
        <div className="space-y-6">
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            <h2 className="text-lg font-bold text-gray-900">🏪 Estado de la tienda</h2>
            <div className="mt-4 flex items-center gap-3">
              ...
              <span className="text-sm font-medium text-gray-700">
                {store.is_active ? "Tienda activa y visible" : "Tienda inactiva"}
              </span>
            </div>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="text-[10px] text-gray-500">
                        {product.quantity_sold} vendidos · {formatCurrency(product.total_revenue)}
                      </div>
                    </div>
                  </div>
                ))}
          ...
          <div className="rounded-2xl bg-linear-to-br from-gray-900 to-gray-800 p-6 text-white shadow-lg">
            ...
            <p className="mt-1 text-xs text-white/70">Amplía tu catálogo en segundos.</p>
            <button
